# Contributing to RDS-JS-Examples

We would love for you to contribute to RDS-JS-Examples and help make it even better than it is
...
Help us keep RDS-JS-Examples open and inclusive. Please read and follow our [Code of Conduct][coc].
...
1. Search [GitHub](https://github.com/mtna/rds-js-examples/pulls) for an open or closed PR
   that relates to your submission. You don't want to duplicate effort.
1. Be sure that an issue describes the problem you're fixing, or documents the design for the feature you'd like to add.
   Discussing the design up front helps to ensure that we're ready to accept your work.
1. Fork the mtna/rds-js-examples repo.
...
1. In GitHub, send a pull request to `rds-js-examples:master`.
...
To help facilitate this practice, our repo is **Commitizen-friendy**. When you are ready to commit changes, simply run:
...
- **build**: Changes that affect the build system or external dependencies (example scopes: parcel, ts)
...
[github]: https://github.com/mtna/rds-js-examples
